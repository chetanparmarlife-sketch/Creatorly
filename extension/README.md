...
The popup defaults to the current production URL, `https://my-build-week-project.vercel.app`. Expand **Dashboard address** in the popup to switch it to `http://localhost:5173` during local development or to save a future custom domain.
