...
export function LandingPage({ navigate }: { navigate(route: AppRoute): void }) {
  ...
  return <main className="home-page">
    ...
    <footer className="home-footer"><Logo/><span>© 2026 Creatorly · Built for influencer teams in India</span><nav aria-label="Footer navigation"><a href="#platform">What you get</a><a href="#addons">Coming next</a><button onClick={() => navigate({ name: "pricing" })}>Pricing</button></nav></footer>
  </main>;
}
