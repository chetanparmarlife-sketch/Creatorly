...
export const demoData = {
  ...
  async search(query: string, filters: CreatorSearchFilters = {}) {
    ...
    return allCreators().flatMap((creator) => {
      ...
      if ((filters.minEngagementRate !== undefined || filters.maxEngagementRate !== undefined) && creator.engagementRateBasis !== filters.engagementRateBasis) return [];
      ...
      return [{
        ...
        engagementRateBasis: creator.engagementRateBasis,
  ...
  async detail(creatorId: string): Promise<CreatorDetailData | null> {
    ...
    return {
      creator: {
        ...
        metricProvenance: creator.metricProvenance,
      },
